...
Multi-agent team engineering patterns, extracted from 小杰的猫窝 — a 10+ agent team building WeChat Mini Programs and Mini Games on [OpenClaw](https://github.com/openclaw/openclaw).
